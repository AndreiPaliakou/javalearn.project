...
public class MainInLoops {
    public static void main(String[] args) {
        ArrayList<Long> myArrayList = new ArrayList<>(List.of(new Long[]{11L, 22L, 33L, 44L}));
        StatisticServiceInLoopsImpl myObject = new StatisticServiceInLoopsImpl();
        System.out.println("The first List<Long>: \n" + myArrayList);

        long resultSum = myObject.sumEvenNumbers(myArrayList);
        ...
        System.out.println("Map without nulls: " + myObject.groupStringsByLastLetter(mySet));
    }
}
